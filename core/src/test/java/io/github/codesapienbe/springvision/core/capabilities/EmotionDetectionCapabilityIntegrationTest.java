...
@DisplayName("Integration: EmotionDetectionCapability")
public class EmotionDetectionCapabilityIntegrationTest {
    ...
    @Test
    void detectEmotionsReturnsList() throws IOException {
        ImageData img = TestImageUtils.createSimpleFaceImage(320, 240);
        List<Detection> res = backend.detectEmotions(img);
