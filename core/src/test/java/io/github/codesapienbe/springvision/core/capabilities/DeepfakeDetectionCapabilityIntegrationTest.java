...
@DisplayName("Integration: DeepfakeDetectionCapability")
public class DeepfakeDetectionCapabilityIntegrationTest {
    ...
    @Test
    void detectDeepfakeReturnsResult() throws IOException {
        ImageData img = TestImageUtils.createSimpleFaceImage(320, 240);
        List<Detection> res = backend.detectDeepfake(img);
