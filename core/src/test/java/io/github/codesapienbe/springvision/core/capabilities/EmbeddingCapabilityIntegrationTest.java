...
@DisplayName("Integration: EmbeddingCapability")
public class EmbeddingCapabilityIntegrationTest {
    ...
    @Test
    void extractEmbeddingsReturnsList() throws IOException {
        ImageData img = TestImageUtils.createSimpleFaceImage(320, 240);
        List<float[]> embs = backend.extractEmbeddings(img, DetectionCategory.FACE);
