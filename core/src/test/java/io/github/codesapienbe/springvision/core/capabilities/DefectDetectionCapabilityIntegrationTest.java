...
@DisplayName("Integration: DefectDetectionCapability")
public class DefectDetectionCapabilityIntegrationTest {
    ...
    @Test
    void detectDefectsReturnsList() throws IOException {
        List<ImageData> images = List.of(TestImageUtils.createRectangleImage(320, 240, java.awt.Color.ORANGE));
        if (backend instanceof DefectDetectionCapability cap) {
            List<Detection> res = cap.detectDefects(images);
