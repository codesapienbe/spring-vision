...
@DisplayName("Integration: FallDetectionCapability")
public class FallDetectionCapabilityIntegrationTest {
    ...
    @Test
    void detectFallProcessesSequence() throws IOException {
        List<ImageData> seq = List.of(TestImageUtils.createPersonSilhouetteImage(320, 240));
        List<Detection> res = backend.detectFall(seq);
