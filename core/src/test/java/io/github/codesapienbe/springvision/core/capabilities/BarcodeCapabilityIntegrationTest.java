...
@DisplayName("Integration: BarcodeCapability")
public class BarcodeCapabilityIntegrationTest {
    ...
    @Test
    void detectBarcodesReturnsList() throws IOException {
        ImageData img = TestImageUtils.createBarcodeImage("12345", 300, 100);
        List<Detection> res = backend.detectBarcodes(img);
