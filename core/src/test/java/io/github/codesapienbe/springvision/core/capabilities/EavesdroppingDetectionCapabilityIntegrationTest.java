...
@DisplayName("Integration: EavesdroppingDetectionCapability")
public class EavesdroppingDetectionCapabilityIntegrationTest {
    ...
    @Test
    void detectEavesdroppingExecutes() throws IOException {
        List<ImageData> seq = List.of(TestImageUtils.createRectangleImage(320, 240, java.awt.Color.LIGHT_GRAY));
        if (backend instanceof EavesdroppingDetectionCapability cap) {
            List<Detection> res = cap.detectEavesdropping(seq);
