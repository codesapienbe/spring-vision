...
@DisplayName("Integration: GeoLocationDetectionCapability")
public class GeoLocationDetectionCapabilityIntegrationTest {
    ...
    @Test
    void detectGeoLocationReturnsList() throws IOException {
        ImageData img = TestImageUtils.createGeometricShapeImage(320, 240, "square");
        if (backend instanceof GeoLocationDetectionCapability cap) {
            List<Detection> res = cap.detectGeoLocation(img);
