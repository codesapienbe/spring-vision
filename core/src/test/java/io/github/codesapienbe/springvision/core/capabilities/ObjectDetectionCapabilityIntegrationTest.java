...
@DisplayName("Integration: ObjectDetectionCapability")
public class ObjectDetectionCapabilityIntegrationTest {
    ...
    @Test
    void detectObjectsReturnsList() throws IOException {
        ImageData img = TestImageUtils.createRectangleImage(640, 480, java.awt.Color.CYAN);
        List<Detection> det = backend.detectObjects(img);
