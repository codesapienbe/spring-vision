...
public final class OpenFaceModel {
    ...
    public float[] generateEmbedding(BufferedImage face, int targetSize) {
        ...
        try {
            ...
            Logs.error("OpenFaceModel", "onnx.unavailable", null, java.util.Map.of("advice", "Set FACEBYTES_OPENFACE_ONNX_PATH or system property facebytes.openface.onnx, or enable auto-download via facebytes.auto_download"));
