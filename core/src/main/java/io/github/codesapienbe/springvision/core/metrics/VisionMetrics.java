package io.github.codesapienbe.springvision.core.metrics;
...
public class VisionMetrics {
    ...
    public static class MetricsSummary {
        ...
        public long getTotalFacesDetected() {
            return totalFacesDetected;
        }

        public long getTotalObjectsDetected() {
            return totalObjectsDetected;
        }

        public long getTotalHandsDetected() {
            return totalHandsDetected;
        }

        public long getTotalPosesDetected() {
            return totalPosesDetected;
        }
        ...
        public long getTotalModelLoads() {
            return totalModelLoads;
        }

        public long getTotalModelDownloads() {
            return totalModelDownloads;
        }
