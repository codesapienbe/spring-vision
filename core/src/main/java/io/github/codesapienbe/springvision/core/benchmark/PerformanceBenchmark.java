package io.github.codesapienbe.springvision.core.benchmark;
...
public class PerformanceBenchmark {
    ...
    public static class BenchmarkResult {
        ...
        public double getAvgDetectionCount() {
            return avgDetectionCount;
        }
    ...
    public static class StressTestResult {
        ...
        public List<StressTestPhase> getPhases() {
            return phases;
        }
    }
    ...
    public static class MemoryAnalysisResult {
        ...
        public long getTotalMemoryIncrease() {
            return totalMemoryIncrease;
        }
    }
    ...
    public static class BenchmarkReport {
        ...
        // Getters
        public Map<DetectionType, BenchmarkResult> getResults() {
            return results;
        }

        public Map<DetectionType, String> getErrors() {
            return errors;
        }
