...
/**
 * Translator for RetinaFace models adapted from DJL examples.
 */
public class RetinaFaceDetectionTranslator implements Translator<Image, DetectedObjects> {
    ...
    public RetinaFaceDetectionTranslator() {
    }
