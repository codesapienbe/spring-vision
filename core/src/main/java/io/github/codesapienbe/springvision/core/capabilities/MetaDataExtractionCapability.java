 ...
 * </p>
 *
 * <p>This capability is useful for applications that need to:
 * <ul>
...
public interface MetaDataExtractionCapability {
     ...
     *
     * <p>Returns a list of detections containing extracted metadata such as:
     * <ul>
     ...
     * </p>
     *
     * <p>The metadata is returned as Detection objects where:
     * <ul>
