...
echo ""
echo "1. Show help:"
echo "   java -jar target/picocli-application-1.0.0-SNAPSHOT.jar --help"
echo ""
echo "2. Detect faces in a single image:"
echo "   java -jar target/picocli-application-1.0.0-SNAPSHOT.jar detect /path/to/image.jpg"
echo ""
echo "3. Detect faces with JSON output:"
echo "   java -jar target/picocli-application-1.0.0-SNAPSHOT.jar detect /path/to/image.jpg -o json"
echo ""
echo "4. Detect faces with verbose output:"
echo "   java -jar target/picocli-application-1.0.0-SNAPSHOT.jar detect /path/to/image.jpg -v"
echo ""
echo "5. Save results to file:"
echo "   java -jar target/picocli-application-1.0.0-SNAPSHOT.jar detect /path/to/image.jpg --save-results results.txt"
echo ""
echo "6. Check health status:"
echo "   java -jar target/picocli-application-1.0.0-SNAPSHOT.jar health"
echo ""
