package io.github.codesapienbe.springvision.facebytes;
...
public final class FaceBytesBackend implements VisionBackend, FaceDetectionCapability, EmbeddingCapability,
    ...
    public boolean isHealthy() {
        try {
            ...
            Class.forName("io.github.codesapienbe.springvision.facebytes.core.DeepFace");
            return true;
        } catch (Throwable t) {
            return false;
        }
    ...
    private List<Detection> convertToDetectionsWithEnhancements(List<EmbeddingResult> embeddings, BufferedImage image) {
        ...
        for (int i = 0; i < embeddings.size(); i++) {
            ...
            var bbox = new io.github.codesapienbe.springvision.core.BoundingBox(nx, ny, nw, nh);
