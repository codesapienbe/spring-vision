...
public class VisionProperties {
    ...
    public static class Metrics {
         ...
         */
        private long collectionInterval = 60000; // 1 minute
        ...
        /**
         * Gets whether detailed metrics are enabled.
         *
        ...
        /**
         * Sets whether detailed metrics are enabled.
         *
         * @param detailed whether to enable detailed metrics
         */
