package io.github.codesapienbe.springvision.examples.picocliapplication.config;
...
public class VisionConfig {
    ...
    private static class BasicBackend implements io.github.codesapienbe.springvision.core.VisionBackend {
        ...
        @Override
        public java.util.List<io.github.codesapienbe.springvision.core.Detection> detectFaces(io.github.codesapienbe.springvision.core.ImageData imageData) {
            // Return empty list for fallback implementation
            return java.util.List.of();
        }

        @Override
        public java.util.List<io.github.codesapienbe.springvision.core.Detection> detectObjects(io.github.codesapienbe.springvision.core.ImageData imageData) {
            // Return empty list for fallback implementation
            return java.util.List.of();
        }
    }
