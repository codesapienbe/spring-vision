package io.github.codesapienbe.springvision.examples.vaadinapplication;
...
@SpringBootApplication(
    scanBasePackages = {
        "io.github.codesapienbe.springvision.core.config",  // auto-config beans & props
        "io.github.codesapienbe.springvision.core",          // core domain + backend
        "io.github.codesapienbe.springvision.starter",        // REST API (VisionController)
        "io.github.codesapienbe.springvision.examples.vaadinapplication" // local Vaadin code
    }
)
