package io.github.codesapienbe.springvision.examples.basicfacedetection.controller;
...
public class FaceDetectionController {
     ...
     */
    private final io.github.codesapienbe.springvision.core.async.AsyncVisionProcessor asyncProcessor;
    ...
    public FaceDetectionController(VisionTemplate visionTemplate, WebClient.Builder webClientBuilder) {
        ...
        this.asyncProcessor = new io.github.codesapienbe.springvision.core.async.AsyncVisionProcessor(visionTemplate);
    }
        ...
        try {
            ...
            if (result.hasDetections()) {
                ...
                for (Detection d : sortedDetections) {
                    ...
                    io.github.codesapienbe.springvision.core.BoundingBox b = d.boundingBox();
    ...
    public ResponseEntity<java.util.Map<String, Object>> health() {
        ...
        java.util.Set<io.github.codesapienbe.springvision.core.DetectionType> types = visionTemplate.getSupportedDetectionTypes();
        return ResponseEntity.ok(java.util.Map.of(
            ...
            "supportedDetectionTypes", types.stream().map(io.github.codesapienbe.springvision.core.DetectionType::getCode).toList()
        ));
    }
    ...
    public ResponseEntity<java.util.List<String>> supportedTypes() {
        java.util.List<String> types = visionTemplate.getSupportedDetectionTypes().stream()
            .map(io.github.codesapienbe.springvision.core.DetectionType::getCode)
            .sorted()
            .toList();
    ...
    public ResponseEntity<java.util.Map<String, Object>> detectMultipleApi(
        ...
        try {
            java.util.List<io.github.codesapienbe.springvision.core.DetectionType> types = java.util.Arrays.stream(detectionTypesCsv.split(","))
                .map(String::trim)
                .filter(s -> !s.isEmpty())
                .map(io.github.codesapienbe.springvision.core.DetectionType::fromCode)
                .toList();
            ...
            java.util.Map<String, Object> payload = new java.util.HashMap<>();
            payload.put("types", types.stream().map(io.github.codesapienbe.springvision.core.DetectionType::getCode).toList());
    ...
    public ResponseEntity<java.util.Map<String, Object>> getAsyncTask(@org.springframework.web.bind.annotation.PathVariable("taskId") String taskId) {
        io.github.codesapienbe.springvision.core.async.TaskProgress progress = asyncProcessor.getTaskProgress(taskId);
        if (progress == null) {
    ...
    public ResponseEntity<java.util.Map<String, Object>> batchFaces(@RequestParam("files") java.util.List<MultipartFile> files) {
        try {
            ...
            io.github.codesapienbe.springvision.core.batch.BatchVisionProcessor batch = new io.github.codesapienbe.springvision.core.batch.BatchVisionProcessor();
            java.util.concurrent.CompletableFuture<java.util.List<VisionResult>> future = batch.processBatch(images, io.github.codesapienbe.springvision.core.DetectionType.FACE, java.util.Map.of());
    ...
    public ResponseEntity<java.util.Map<String, Object>> detectObjects(@RequestParam("file") MultipartFile file) {
        try {
            ImageData imageData = ImageData.fromBytes(file.getBytes());
            VisionResult result = visionTemplate.detect(imageData, io.github.codesapienbe.springvision.core.DetectionType.OBJECT);
            return ResponseEntity.ok(java.util.Map.of(
    ...
    public ResponseEntity<java.util.Map<String, Object>> detectWithQuery(@RequestParam("file") MultipartFile file,
        ...
        try {
            ...
            io.github.codesapienbe.springvision.core.DetectionQuery.Builder queryBuilder = new io.github.codesapienbe.springvision.core.DetectionQuery.Builder()
                .type(type)
                .minConfidence(minConfidence)
                .maxDetections(maxDetections);

            io.github.codesapienbe.springvision.core.DetectionQuery query = queryBuilder.build();
            ImageData imageData = ImageData.fromBytes(file.getBytes());
            VisionResult result = visionTemplate.detect(imageData, query);
