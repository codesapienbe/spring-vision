...
import io.github.codesapienbe.springvision.persistence.repository.PostgreSQLFaceEmbeddingRepository;
...
public class PostgreSQLVectorSimilarityService implements VectorSimilarityService {
    ...
    public String storeFaceEmbedding(io.github.codesapienbe.springvision.persistence.dto.StoreFaceEmbeddingRequest request) {
        ...
        final Object vectorParam = nativeVectorAdapter != null ? nativeVectorAdapter.toInsertValue(io.github.codesapienbe.springvision.persistence.service.VectorConversionHelpers.serializeFloatArrayToBytes(insertEmbedding)) : formatPgVector(insertEmbedding);
    ...
    public List<SimilaritySearchResult> findSimilarFaces(SimilaritySearchRequest request) {
        ...
        Object queryParam = nativeVectorAdapter != null && effectiveEmbedding != null ? nativeVectorAdapter.toQueryParam(io.github.codesapienbe.springvision.persistence.service.VectorConversionHelpers.serializeFloatArrayToBytes(effectiveEmbedding)) : formatPgVector(effectiveEmbedding == null ? new float[0] : effectiveEmbedding);
