...
public class JpaVectorSimilarityService implements VectorSimilarityService {
    ...
    public String storeFaceEmbedding(StoreFaceEmbeddingRequest request) {
        ...
        embedding.setNativeVector(io.github.codesapienbe.springvision.persistence.service.VectorConversionHelpers.serializeFloatArrayToBytes(request.embedding()));
