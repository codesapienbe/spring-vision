...
public class FaceLookupOptions {
    ...
    public Set<String> getIncludePersonIds() { return includePersonIds; }
    public void setIncludePersonIds(Set<String> includePersonIds) { this.includePersonIds = includePersonIds; }
    public Set<String> getExcludePersonIds() { return excludePersonIds; }
    public void setExcludePersonIds(Set<String> excludePersonIds) { this.excludePersonIds = excludePersonIds; }
} 